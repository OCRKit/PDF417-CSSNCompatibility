//
//  CSSNCardProcessRequestOptions.h
//
...
#import "CSSNCardRegion.h"
#import "CSSNCardType.h"

@interface CSSNCardProcessRequestOptions : NSObject
...
@property (nonatomic) CSSNCardRegion                region; // Default is United States.
...
@property (nonatomic, readonly) CSSNCardType        processingType; //This is the type of card you're trying to process.
 ...
 */
+ (CSSNCardProcessRequestOptions*)defaultRequestOptionsForCardType:(CSSNCardType)type;
